...
name: mcp-developer
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'mcp-developer' or mentions 'mcp-developer'. Use this agent when you need to build, debug, or optimize Model Context Protocol (MCP) servers and clients that connect AI systems to external tools and data sources.
