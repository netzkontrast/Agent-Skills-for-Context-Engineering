...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'backend-developer' or mentions 'backend-developer'. Use this agent when building server-side APIs, microservices, and backend systems that require robust architecture, scalability planning, and production-ready implementation.
