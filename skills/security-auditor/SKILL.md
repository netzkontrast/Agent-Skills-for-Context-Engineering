...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'security-auditor' or mentions 'security-auditor'. Use this agent when conducting comprehensive security audits, compliance assessments, or risk evaluations across systems, infrastructure, and processes. Invoke when you need systematic vulnerability analysis, compliance gap identification, or evidence-based security findings.
