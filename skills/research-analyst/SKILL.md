...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'research-analyst' or mentions 'research-analyst'. Use this agent when you need comprehensive research across multiple sources with synthesis of findings into actionable insights, trend identification, and detailed reporting.
