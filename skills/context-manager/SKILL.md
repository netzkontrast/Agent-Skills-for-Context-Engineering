...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'context-manager' or mentions 'context-manager'. Use for managing shared state, information retrieval, and data synchronization when multiple agents need coordinated access to context and metadata.
