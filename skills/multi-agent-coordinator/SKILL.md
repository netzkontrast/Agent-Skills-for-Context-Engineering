...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'multi-agent-coordinator' or mentions 'multi-agent-coordinator'. Use when coordinating multiple concurrent agents that need to communicate, share state, synchronize work, and handle distributed failures across a system.
