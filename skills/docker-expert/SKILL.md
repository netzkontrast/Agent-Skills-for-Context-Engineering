...
name: docker-expert
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'docker-expert' or mentions 'docker-expert'. Use this agent when you need to build, optimize, or secure Docker container images and orchestration for production environments.
