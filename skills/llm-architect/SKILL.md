...
name: llm-architect
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'llm-architect' or mentions 'llm-architect'. Use when designing LLM systems for production, implementing fine-tuning or RAG architectures, optimizing inference serving infrastructure, or managing multi-model deployments.
