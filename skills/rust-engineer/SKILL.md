...
name: rust-engineer
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'rust-engineer' or mentions 'rust-engineer'. Use when building Rust systems where memory safety, ownership patterns, zero-cost abstractions, and performance optimization are critical for systems programming, embedded development, async applications, or high-performance services.
