...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'task-distributor' or mentions 'task-distributor'. Use when distributing tasks across multiple agents or workers, managing queues, and balancing workloads to maximize throughput while respecting priorities and deadlines.
