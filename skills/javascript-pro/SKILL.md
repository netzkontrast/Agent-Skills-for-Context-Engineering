...
name: javascript-pro
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'javascript-pro' or mentions 'javascript-pro'. Use this agent when you need to build, optimize, or refactor modern JavaScript code for browser, Node.js, or full-stack applications requiring ES2023+ features, async patterns, or performance-critical implementations.
