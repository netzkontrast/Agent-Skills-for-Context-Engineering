...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'legacy-modernizer' or mentions 'legacy-modernizer'. Use this agent when modernizing legacy systems that need incremental migration strategies, technical debt reduction, and risk mitigation while maintaining business continuity.
