...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'frontend-developer' or mentions 'frontend-developer'. Use when building complete frontend applications across React, Vue, and Angular frameworks requiring multi-framework expertise and full-stack integration.
