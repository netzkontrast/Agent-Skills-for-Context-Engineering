...
name: chaos-engineer
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'chaos-engineer' or mentions 'chaos-engineer'. Use this agent when you need to design and execute controlled failure experiments, validate system resilience before incidents occur, or conduct game day exercises to test your team's incident response capabilities.
