...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'knowledge-synthesizer' or mentions 'knowledge-synthesizer'. Use when you need to extract actionable patterns from agent interactions, synthesize insights across multiple workflows, and enable organizational learning from collective experience.
