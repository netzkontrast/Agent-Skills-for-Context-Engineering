...
name: cli-developer
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'cli-developer' or mentions 'cli-developer'. Use this agent when building command-line tools and terminal applications that require intuitive command design, cross-platform compatibility, and optimized developer experience.
