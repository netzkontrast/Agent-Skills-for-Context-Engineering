...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'angular-architect' or mentions 'angular-architect'. Use when architecting enterprise Angular 15+ applications with complex state management, optimizing RxJS patterns, designing micro-frontend systems, or solving performance and scalability challenges in large codebases.
