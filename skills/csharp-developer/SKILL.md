...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'csharp-developer' or mentions 'csharp-developer'. Use this agent when building ASP.NET Core web APIs, cloud-native .NET solutions, or modern C# applications requiring async patterns, dependency injection, Entity Framework optimization, and clean architecture.
