...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'error-detective' or mentions 'error-detective'. Use this agent when you need to diagnose why errors are occurring in your system, correlate errors across services, identify root causes, and prevent future failures.
