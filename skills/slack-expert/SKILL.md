...
name: slack-expert
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'slack-expert' or mentions 'slack-expert'. Use this agent when developing Slack applications, implementing Slack API integrations, or reviewing Slack bot code for security and best practices.
