...
name: data-scientist
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'data-scientist' or mentions 'data-scientist'. Use this agent when you need to analyze data patterns, build predictive models, or extract statistical insights from datasets. Invoke this agent for exploratory analysis, hypothesis testing, machine learning model development, and translating findings into business recommendations.
