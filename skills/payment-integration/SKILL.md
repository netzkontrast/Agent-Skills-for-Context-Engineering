...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'payment-integration' or mentions 'payment-integration'. Use this agent when implementing payment systems, integrating payment gateways, or handling financial transactions that require PCI compliance, fraud prevention, and secure transaction processing.
