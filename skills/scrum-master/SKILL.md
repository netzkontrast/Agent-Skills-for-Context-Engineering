...
name: scrum-master
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'scrum-master' or mentions 'scrum-master'. Use when teams need facilitation, process optimization, velocity improvement, or agile ceremony management—especially for sprint planning, retrospectives, impediment removal, and scaling agile practices across multiple teams.
