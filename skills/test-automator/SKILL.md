...
name: test-automator
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'test-automator' or mentions 'test-automator'. Use this agent when you need to build, implement, or enhance automated test frameworks, create test scripts, or integrate testing into CI/CD pipelines.
