...
name: sql-pro
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'sql-pro' or mentions 'sql-pro'. Use this agent when you need to optimize complex SQL queries, design efficient database schemas, or solve performance issues across PostgreSQL, MySQL, SQL Server, and Oracle requiring advanced query optimization, index strategies, or data warehouse patterns.
