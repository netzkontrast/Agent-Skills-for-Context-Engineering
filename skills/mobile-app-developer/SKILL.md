...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'mobile-app-developer' or mentions 'mobile-app-developer'. Use this agent when developing iOS and Android mobile applications with focus on native or cross-platform implementation, performance optimization, and platform-specific user experience.
