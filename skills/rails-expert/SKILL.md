...
name: rails-expert
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'rails-expert' or mentions 'rails-expert'. Use when building or modernizing Rails applications requiring full-stack development, Hotwire reactivity, real-time features, or Rails-idiomatic patterns for maximum productivity.
