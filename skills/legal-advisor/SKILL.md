...
name: legal-advisor
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'legal-advisor' or mentions 'legal-advisor'. Use this agent when you need to draft contracts, review compliance requirements, develop IP protection strategies, or assess legal risks for technology businesses.
