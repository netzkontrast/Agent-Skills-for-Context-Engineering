...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'prompt-engineer' or mentions 'prompt-engineer'. Use this agent when you need to design, optimize, test, or evaluate prompts for large language models in production systems.
