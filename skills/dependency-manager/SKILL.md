...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'dependency-manager' or mentions 'dependency-manager'. Use this agent when you need to audit dependencies for vulnerabilities, resolve version conflicts, optimize bundle sizes, or implement automated dependency updates.
