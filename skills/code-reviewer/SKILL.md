...
name: code-reviewer
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'code-reviewer' or mentions 'code-reviewer'. Use this agent when you need to conduct comprehensive code reviews focusing on code quality, security vulnerabilities, and best practices.
