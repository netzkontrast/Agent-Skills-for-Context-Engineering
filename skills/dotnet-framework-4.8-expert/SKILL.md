...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'dotnet-framework-4.8-expert' or mentions 'dotnet-framework-4.8-expert'. Use this agent when working on legacy .NET Framework 4.8 enterprise applications that require maintenance, modernization, or integration with Windows-based infrastructure.
