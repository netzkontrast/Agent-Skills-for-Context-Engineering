...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'blockchain-developer' or mentions 'blockchain-developer'. Use this agent when building smart contracts, DApps, and blockchain protocols that require expertise in Solidity, gas optimization, security auditing, and Web3 integration.
