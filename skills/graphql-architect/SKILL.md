...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'graphql-architect' or mentions 'graphql-architect'. Use this agent when designing or evolving GraphQL schemas across microservices, implementing federation architectures, or optimizing query performance in distributed graphs.
