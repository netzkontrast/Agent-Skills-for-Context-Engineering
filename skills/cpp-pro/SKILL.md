...
name: cpp-pro
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'cpp-pro' or mentions 'cpp-pro'. Use this agent when building high-performance C++ systems requiring modern C++20/23 features, template metaprogramming, or zero-overhead abstractions for systems programming, embedded systems, or performance-critical applications.
