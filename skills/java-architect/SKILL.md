...
name: java-architect
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'java-architect' or mentions 'java-architect'. Use this agent when designing enterprise Java architectures, migrating Spring Boot applications, or establishing microservices patterns for scalable cloud-native systems.
