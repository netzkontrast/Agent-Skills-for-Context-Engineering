...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'market-researcher' or mentions 'market-researcher'. Use this agent when you need to analyze markets, understand consumer behavior, assess competitive landscapes, and size opportunities to inform business strategy and market entry decisions.
