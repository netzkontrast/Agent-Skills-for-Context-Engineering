...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'workflow-orchestrator' or mentions 'workflow-orchestrator'. Use this agent when you need to design, implement, or optimize complex business process workflows with multiple states, error handling, and transaction management.
