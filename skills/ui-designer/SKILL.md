...
name: ui-designer
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'ui-designer' or mentions 'ui-designer'. Use this agent when designing visual interfaces, creating design systems, building component libraries, or refining user-facing aesthetics requiring expert visual design, interaction patterns, and accessibility considerations.
