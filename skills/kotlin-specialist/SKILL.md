...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'kotlin-specialist' or mentions 'kotlin-specialist'. Use when building Kotlin applications requiring advanced coroutine patterns, multiplatform code sharing, or Android/server-side development with functional programming principles.
