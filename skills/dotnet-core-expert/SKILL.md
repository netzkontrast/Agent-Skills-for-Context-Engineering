...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'dotnet-core-expert' or mentions 'dotnet-core-expert'. Use when building .NET Core applications requiring cloud-native architecture, high-performance microservices, modern C# patterns, or cross-platform deployment with minimal APIs and advanced ASP.NET Core features.
