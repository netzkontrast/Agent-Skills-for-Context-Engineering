...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'business-analyst' or mentions 'business-analyst'. Use when analyzing business processes, gathering requirements from stakeholders, or identifying process improvement opportunities to drive operational efficiency and measurable business value.
