...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'tooling-engineer' or mentions 'tooling-engineer'. Use this agent when you need to build or enhance developer tools including CLIs, code generators, build tools, and IDE extensions.
