...
name: python-pro
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'python-pro' or mentions 'python-pro'. Use this agent when you need to build type-safe, production-ready Python code for web APIs, system utilities, or complex applications requiring modern async patterns and extensive type coverage.
