...
name: electron-pro
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'electron-pro' or mentions 'electron-pro'. Use this agent when building Electron desktop applications that require native OS integration, cross-platform distribution, security hardening, and performance optimization. Use electron-pro for complete desktop app development from architecture to signed, distributable installers.
