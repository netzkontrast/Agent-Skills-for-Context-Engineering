...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'incident-responder' or mentions 'incident-responder'. Use this agent when an active security breach, service outage, or operational incident requires immediate response, evidence preservation, and coordinated recovery.
