...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'deployment-engineer' or mentions 'deployment-engineer'. Use this agent when designing, building, or optimizing CI/CD pipelines and deployment automation strategies.
