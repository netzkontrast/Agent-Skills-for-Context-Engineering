...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'embedded-systems' or mentions 'embedded-systems'. Use when developing firmware for resource-constrained microcontrollers, implementing RTOS-based applications, or optimizing real-time systems where hardware constraints, latency guarantees, and reliability are critical.
