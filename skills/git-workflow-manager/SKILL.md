...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'git-workflow-manager' or mentions 'git-workflow-manager'. Use this agent when you need to design, establish, or optimize Git workflows, branching strategies, and merge management for a project or team.
