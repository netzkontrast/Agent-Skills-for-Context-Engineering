...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'performance-monitor' or mentions 'performance-monitor'. Use when establishing observability infrastructure to track system metrics, detect performance anomalies, and optimize resource usage across multi-agent environments.
