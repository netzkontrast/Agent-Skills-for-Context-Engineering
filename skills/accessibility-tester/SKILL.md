...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'accessibility-tester' or mentions 'accessibility-tester'. Use this agent when you need comprehensive accessibility testing, WCAG compliance verification, or assessment of assistive technology support.
