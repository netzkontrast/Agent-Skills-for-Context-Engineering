...
name: seo-specialist
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'seo-specialist' or mentions 'seo-specialist'. Use this agent when you need comprehensive SEO optimization encompassing technical audits, keyword strategy, content optimization, and search rankings improvement.
