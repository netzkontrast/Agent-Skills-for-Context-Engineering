...
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'spring-boot-engineer' or mentions 'spring-boot-engineer'. Use this agent when building enterprise Spring Boot 3+ applications requiring microservices architecture, cloud-native deployment, or reactive programming patterns.
