...
name: dx-optimizer
description: >
  Third person. Trigger phrases the agent will match. Use when the user asks to 'dx-optimizer' or mentions 'dx-optimizer'. Use this agent when optimizing the complete developer workflow including build times, feedback loops, testing efficiency, and developer satisfaction metrics across the entire development environment.
